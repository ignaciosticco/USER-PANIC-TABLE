...
PairStyle(panic/table/kcomp,PairPanicTableKcomp)

#else

#ifndef LMP_PAIR_PANIC_TABLE_KCOMP_H
#define LMP_PAIR_PANIC_TABLE_KCOMP_H

#include "pair.h"

namespace LAMMPS_NS {

class PairPanicTableKcomp : public Pair {
 public:
  PairPanicTableKcomp(class LAMMPS *);
  virtual ~PairPanicTableKcomp();
