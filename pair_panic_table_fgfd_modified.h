...
PairStyle(panic/table/fgfd/modified,PairPanicTableFgfdModified)

#else

#ifndef LMP_PAIR_PANIC_TABLE_FGFD_MODIFIED_H
#define LMP_PAIR_PANIC_TABLE_FGFD_MODIFIED_H

#include "pair.h"

namespace LAMMPS_NS {

class PairPanicTableFgfdModified : public Pair {
 public:
  PairPanicTableFgfdModified(class LAMMPS *);
  virtual ~PairPanicTableFgfdModified();
