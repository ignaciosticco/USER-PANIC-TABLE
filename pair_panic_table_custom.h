...
PairStyle(panic/table/custom,PairPanicTableCustom)

#else

#ifndef LMP_PAIR_PANIC_TABLE_CUSTOM_H
#define LMP_PAIR_PANIC_TABLE_CUSTOM_H

#include "pair.h"

namespace LAMMPS_NS {

class PairPanicTableCustom : public Pair {
 public:
  PairPanicTableCustom(class LAMMPS *);
  virtual ~PairPanicTableCustom();
 ...
 protected:
  ...
  double vd,TAU,A,B,KCOMP,KAPPA,KAPPAWALL;       // Sticco 4 Nov 2019
  ...
  void compute_desiredforce(double x, double y, double vx, double vy, double* force_desired, double vd, Table *tb,double MOT); // Sticco 18 Jun 2018
