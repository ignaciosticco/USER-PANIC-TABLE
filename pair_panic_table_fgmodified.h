...
PairStyle(panic/table/fgmodified,PairPanicTableFgmodified)

#else

#ifndef LMP_PAIR_PANIC_TABLE_FGMODIFIED_H
#define LMP_PAIR_PANIC_TABLE_FGMODIFIED_H

#include "pair.h"

namespace LAMMPS_NS {

class PairPanicTableFgmodified : public Pair {
 public:
  PairPanicTableFgmodified(class LAMMPS *);
  virtual ~PairPanicTableFgmodified();
 ...
 protected:
  ...
  double vd,factor_fgpedestrian,factor_fgwall;      // Sticco 3 April 2019
