...
#include <cstdlib>
#include <ctime>
#include "pair_panic_table_fgfd_modified.h"
#include "atom.h"
#include "force.h"
#include "comm.h"
...
PairPanicTableFgfdModified::PairPanicTableFgfdModified(LAMMPS *lmp) : Pair(lmp)
{
  ntables = 0;
  tables = NULL;
}
...
PairPanicTableFgfdModified::~PairPanicTableFgfdModified()
{
  if (copymode) return;
...
void PairPanicTableFgfdModified::compute(int eflag, int vflag)
{
...
void PairPanicTableFgfdModified::allocate()
{
  allocated = 1;
...
void PairPanicTableFgfdModified::settings(int narg, char **arg)
{
...
void PairPanicTableFgfdModified::coeff(int narg, char **arg)
{
...
double PairPanicTableFgfdModified::init_one(int i, int j)
{
...
void PairPanicTableFgfdModified::read_table(Table *tb, char *file, char *keyword)
{
  char line[MAXLINE];
...
void PairPanicTableFgfdModified::bcast_table(Table *tb)
{
...
void PairPanicTableFgfdModified::spline_table(Table *tb)
{
...
void PairPanicTableFgfdModified::param_extract(Table *tb, char *line)
{
  tb->ninput = 0;
  tb->rflag = NONE;
  tb->fpflag = 0;
...
void PairPanicTableFgfdModified::compute_table(Table *tb)
{
  int tlm1 = tablength-1;
...
void PairPanicTableFgfdModified::null_table(Table *tb)
{
...
void PairPanicTableFgfdModified::free_table(Table *tb)
{
...
void PairPanicTableFgfdModified::spline(double *x, double *y, int n,
...
double PairPanicTableFgfdModified::splint(double *xa, double *ya, double *y2a, int n, double x)
{
  int klo,khi,k;
  double h,b,a,y;
...
void PairPanicTableFgfdModified::write_restart(FILE *fp)
{
...
void PairPanicTableFgfdModified::read_restart(FILE *fp)
{
...
void PairPanicTableFgfdModified::write_restart_settings(FILE *fp)
{
...
void PairPanicTableFgfdModified::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairPanicTableFgfdModified::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairPanicTableFgfdModified::extract(const char *str, int &dim)
{
...
void PairPanicTableFgfdModified::wall_extract(Table *tb, char *line,FILE *fp)
{
  int  i,n;
  char word[MAXLINE];
...
void PairPanicTableFgfdModified::compute_wallforce(double x, double y, double vx, double vy, double force_wall[], Table *tb, double rad){
...
void PairPanicTableFgfdModified::compute_desiredforce(double x, double y, double vx, double vy, double* force_desired, double vd, Table *tb){
...
void PairPanicTableFgfdModified::search_near_opening(int i, double vector_vd_x[], double vector_vd_y[], Table *tb){
